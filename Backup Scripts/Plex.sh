...
rsync -e 'ssh -p 1010' -avzp /media/easystore2/Nextcloud_Data.tar.gz user@chse.xyz:$DestFolder/$DATE/Nextcloud_Data.tar.gz # Transfer to VM.
...
rsync -e 'ssh -p 1010' -avzp /media/easystore2/DockerVols.tar.gz user@chse.xyz:$DestFolder/$DATE/DockerVols.tar.gz # Transfer to VM.
